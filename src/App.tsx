  ...
  return (
    <>
      ...
      {playerState === 'disabled' && (
        <div className="absolute inset-0 bg-cyan-950/20 border-4 border-cyan-500/30 m-4 pointer-events-none flex flex-col items-center justify-center transition-all duration-300 rounded-lg">
          <div className="text-cyan-400 text-4xl md:text-6xl font-black tracking-widest drop-shadow-[0_0_25px_rgba(34,211,238,1)] text-center animate-pulse">
            SPAWN SHIELD ACTIVE
          </div>
          <div className="text-white/80 text-[10px] md:text-xs font-semibold mt-3 drop-shadow-[0_0_4px_rgba(0,0,0,0.5)] bg-black/60 px-4 py-2 rounded-full uppercase tracking-widest border border-cyan-500/20">
            SYSTEM FROZEN — RE-ENGAGING IN 2.5s
          </div>
        </div>
      )}
      ...
      {gameState === 'menu' && (
        <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center z-10 pointer-events-auto">
          ...
          <p className="text-gray-400 mb-8 text-center max-w-md leading-relaxed">
            WASD to move. Mouse to look & shoot.<br/>
            Hold <span className="text-cyan-400 font-bold">Q</span> or <span className="text-cyan-400 font-bold">E</span> to lean left or right.<br/>
